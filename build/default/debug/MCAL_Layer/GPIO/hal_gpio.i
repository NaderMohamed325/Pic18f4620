...
# 1 "MCAL_Layer/GPIO/../std_lin.h" 1
# 13 "MCAL_Layer/GPIO/../std_lin.h"
...
# 14 "MCAL_Layer/GPIO/../std_lin.h" 2
...
# 16 "MCAL_Layer/GPIO/../std_lin.h" 2
...
# 1 "MCAL_Layer/GPIO/../decive_config.h" 1
# 18 "MCAL_Layer/GPIO/hal_gpio.h" 2
# 1 "MCAL_Layer/GPIO/hal_pio_cnfg.h" 1
# 19 "MCAL_Layer/GPIO/hal_gpio.h" 2
# 39 "MCAL_Layer/GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW = 0,
    GPIO_HIGH
} logic_t;
...
Std_ReturnType gpio_pin_read_logic(const pin_config_t * _pin_config, logic_t *logic_) {
    Std_ReturnType ret = (Std_ReturnType)0X01;
    if (((void*)0) == _pin_config || ((void*)0) == logic_ || _pin_config->pin > 8 - 1) {
        ret = (Std_ReturnType)0X00;
    } else {
        *(logic_) = ((*port_registers[_pin_config->port] >> _pin_config->pin) & (uint8)1);
